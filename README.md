## COPYRIGHT: NgrokLAN is forked of [Ngrok-LAN by Alujjdnd](https://github.com/Alujjdnd/Ngrok-LAN/) but make for 1.16.5
...
## Making someone Operators in your NgrokLAN
We suggest to use LanOperators to /op or /deop someone, which its public at [Modrinth](https://modrinth.com/mod/lan-operators) and [Curseforge](https://www.curseforge.com/minecraft/mc-mods/lan-operators)
or will be remake by me:)
